...
public class PreprocessingAnalysis {
    ...
    private static void analysePOSTAGs() {
        ...
        QALDCorpus trainCorpus = CorpusLoader.load(CorpusLoader.Dataset.qaldSubset, includeYAGO, includeAggregation, includeUNION, onlyDBO, isHybrid);
        QALDCorpus testCorpus = CorpusLoader.load(CorpusLoader.Dataset.qaldSubset, includeYAGO, includeAggregation, includeUNION, onlyDBO, isHybrid);
